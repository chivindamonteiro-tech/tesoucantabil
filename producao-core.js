/* ============================================================
   ...
   Este módulo já está LIGADO à Logística: ao finalizar uma Ordem
   de Produção, dá saída automática da matéria-prima consumida no
   Armazém Central e entrada do produto acabado na Área de
   Produção (ver secção "INTEGRAÇÃO COM A LOGÍSTICA" mais abaixo).
   Requer que logistica-core.js esteja incluído ANTES deste
   ficheiro na página; se não estiver, a integração é ignorada
   silenciosamente e o módulo continua a funcionar sozinho.
